...
void goo()
{
    ...
    swap_context(&main_context, nullptr); // Transfer control back to the main context
}
...
int main()
{
    ...
    // Call swap_context with main context
    swap_context(nullptr, &main_context);

    // Control will be transferred to foo
    // Once foo completes, it will return to swap_context, and swap_context will set the context back to main
    ...
    // Once goo completes, it will return to swap_context, and swap_context will set the context back to main
    // Due to the volatile keyword on x, the compiler will not optimize the condition
    if (x)
    {
